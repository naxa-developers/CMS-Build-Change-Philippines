...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__vendor_pnotify_pnotify_custom_min_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__vendor_pnotify_pnotify_custom_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__vendor_pnotify_pnotify_custom_min_js__);
...
window.VueMultiselect = __webpack_require__(25);
...
window.PNotify = __WEBPACK_IMPORTED_MODULE_4__vendor_pnotify_pnotify_custom_min_js___default.a;
window.$ = __WEBPACK_IMPORTED_MODULE_3_jquery___default.a;
const channels = __webpack_require__(10);

__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_2_vue_resource__["a" /* default */]);
//Vue.use(VueMultiselect);


window.Steps = new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
    el: '#app',
    template: `
<div>
    ...
    methods: {
        ...
        getStep: function (step) {
            ...
            self.$http.get('/core/api/step/' + step.id + '/', {
                params: {}
            }).then(successCallback, errorCallback);
        },
        newStep: function () {
        ...
        saveStep: function () {
            ...
            if (!self.step.hasOwnProperty("id")) {
                ...
                function successCallback(response) {
                    ...
                    self.error = "";
                    new __WEBPACK_IMPORTED_MODULE_4__vendor_pnotify_pnotify_custom_min_js___default.a({
                        title: 'Saved',
                ...
                function successCallback(response) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].set(self.steps, index, response.body);
        ...
        saveChecklist: function () {
            ...
            if (!self.checklist.hasOwnProperty("id")) {
                ...
                function successCallback(response) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].set(self.checklists, index, response.body);
...
!function (t, e) {
   true ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.VueMultiselect = e() : t.VueMultiselect = e();
}(this, function () {
  return function (t) {
    function e(n) {
    ...
    function n(t, e, i) {
    ...
    }Object.defineProperty(e, "__esModule", { value: !0 });var c = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
      return typeof t;
    } : function (t) {
      ...
      return t && t.__esModule ? t : { default: t };
        ...
        d = function () {
      for (var t = arguments.length, e = Array(t), i = 0; i < t; i++) e[i] = arguments[i];return function (t) {
        ...
        return { search: "", isOpen: !1, prefferedOpenDirection: "below", optimizedHeight: this.maxHeight, internalValue: this.value || 0 === this.value ? (0, p.default)(Array.isArray(this.value) ? this.value : [this.value]) : [] };
            ...
            return s(t) ? "" : e ? t[e] : t;
          } }, taggable: { type: Boolean, default: !1 }, tagPlaceholder: { type: String, default: "Press enter to create a tag" }, max: { type: [Number, Boolean], default: !1 }, id: { default: null }, optionsLimit: { type: Number, default: 1e3 }, groupValues: { type: String }, groupLabel: { type: String }, blockKeys: { type: Array, default: function () {
            return [];
          } }, preserveSearch: { type: Boolean, default: !1 } }, mounted: function () {
        ...
        } }, watch: { internalValue: function (t, e) {
    ...
    }Object.defineProperty(e, "__esModule", { value: !0 });var s = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
      return typeof t;
    } : function (t) {
      return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t;
    };e.default = n;
    ...
    function n(t) {
      return t && t.__esModule ? t : { default: t };
        ...
        r = n(o);e.default = { name: "vue-multiselect", mixins: [l.default, r.default], props: { name: { type: String, default: "" }, selectLabel: { type: String, default: "Press enter to select" }, selectedLabel: { type: String, default: "Selected" }, deselectLabel: { type: String, default: "Press enter to remove" }, showLabels: { type: Boolean, default: !0 }, limit: { type: Number, default: 99999 }, maxHeight: { type: Number, default: 300 }, limitText: { type: Function, default: function (t) {
            return "and " + t + " more";
          } }, loading: { type: Boolean, default: !1 }, disabled: { type: Boolean, default: !1 }, openDirection: { type: String, default: "" }, showNoResults: { type: Boolean, default: !0 }, tabindex: { type: Number, default: 0 } }, computed: { visibleValue: function () {
    ...
    t.exports = function (t, e, i, n) {
      var s,
          l = t = t || {},
          o = typeof t.default;"object" !== o && "function" !== o || (s = t, l = t.default);var r = "function" == typeof l ? l.options : l;if (e && (r.render = e.render, r.staticRenderFns = e.staticRenderFns), i && (r._scopeId = i), n) {
    ...
    t.exports = { render: function () {
        var t = this,
            e = t.$createElement,
            i = t._self._c || e;return i("div", { staticClass: "multiselect", class: { "multiselect--active": t.isOpen, "multiselect--disabled": t.disabled, "multiselect--above": t.isAbove }, attrs: { tabindex: t.tabindex }, on: { focus: function (e) {
              t.activate();
            }, blur: function (e) {
            ...
            } } }, [t._t("caret", [i("div", { staticClass: "multiselect__select", on: { mousedown: function (e) {
          ...
          return [t._t("tag", [i("span", { staticClass: "multiselect__tag" }, [i("span", { domProps: { textContent: t._s(t.getOptionLabel(e)) } }), t._v(" "), i("i", { staticClass: "multiselect__tag-icon", attrs: { "aria-hidden": "true", tabindex: "1" }, on: { keydown: function (i) {
            ...
            }] } }) : t._e(), t._v(" "), t.searchable ? t._e() : i("span", { staticClass: "multiselect__single", domProps: { textContent: t._s(t.currentOptionLabel) }, on: { mousedown: function (e) {
              e.preventDefault(), t.toggle(e);
            } } })], 2), t._v(" "), i("transition", { attrs: { name: "multiselect" } }, [i("div", { directives: [{ name: "show", rawName: "v-show", value: t.isOpen, expression: "isOpen" }], ref: "list", staticClass: "multiselect__content-wrapper", style: { maxHeight: t.optimizedHeight + "px" }, on: { focus: t.activate, mousedown: function (t) {
              t.preventDefault();
            } } }, [i("ul", { staticClass: "multiselect__content", style: t.contentStyle }, [t._t("beforeList"), t._v(" "), t.multiple && t.max === t.internalValue.length ? i("li", [i("span", { staticClass: "multiselect__option" }, [t._t("maxElements", [t._v("Maximum of " + t._s(t.max) + " options selected. First remove a selected option to select another.")])], 2)]) : t._e(), t._v(" "), !t.max || t.internalValue.length < t.max ? t._l(t.filteredOptions, function (e, n) {
          return i("li", { key: n, staticClass: "multiselect__element" }, [e && (e.$isLabel || e.$isDisabled) ? t._e() : i("span", { staticClass: "multiselect__option", class: t.optionHighlight(n, e), attrs: { "data-select": e && e.isTag ? t.tagPlaceholder : t.selectLabelText, "data-selected": t.selectedLabelText, "data-deselect": t.deselectLabelText }, on: { click: function (i) {
