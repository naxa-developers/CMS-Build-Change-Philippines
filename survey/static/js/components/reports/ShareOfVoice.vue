...
<div id="share-of-voice__company">
    <div class="panel no-border">
        ...
        <div class="tab-container voice-tab sov-filters" style="margin: 0" v-loading="isLoading" element-loading-text="Loading..." element-loading-spinner="el-icon-loading" element-loading-background="white">
            <ul class="nav nav-tabs graph_date_range clearfix" role="tablist" style="z-index:2;">
                ...
                <li v-show="report_sov.current_mode=='custom'" class="pull-right m-hide mb-xs" style="max-width:250px;">
                    <vselect :options="sovMediaOptions" label="name" :value="{'id':'','name':'All Channels'}" v-model="report_sov.selected_channel"  :select-label="''" :show-labels="true"
                            :internal-search="true" :placeholder="'Select Channel'" >
            ...
            <div class="mobile-only" style="z-index:2;">
            ...
            <div class="tab-pane active"  id="sov-body" style="z-index:1;">
                <div >
                    <highcharts :options="report_sov.hconfig" ref="highcharts"></highcharts>
...
export default {
  ...
  methods: {
      set_custom_report_api() {
        ...
        if (this.report_sov.current_mode != 'all') {
          ...
          if (this.report_sov.selected_channel.id) {
              query_string.push('media=' + this.report_sov.selected_channel.id);
            }
      ...
      generate_sov_chart_data(){
          var _this = this;
        //abort previous request if user changes the options abruptly  
        this.cancel_sov_chart_request();
          _this.report_sov.hconfig.subtitle.text = ' Loading...';
          ...
          _this.report_sov.xhr.then(function(result) {
            ...
            _this.loading = false;
            _this.report_sov.hconfig.subtitle.text =  _this.report_sov.selected_channel.name;// + ', ' +this.report_sov.selected_month.name;
            _this.report_sov.hconfig.subtitle.text += ' ';
            _this.report_sov.hconfig.subtitle.text += _this.report_sov.date;
          });
      },
  ...
  computed: {
    ...
    isLoading(){
        return this.report_sov.xhr.readyState && (this.report_sov.xhr.readyState > 0) && (this.report_sov.xhr.readyState < 4);       
    },
  ...
  watch: {
      ...
      'report_sov.selected_channel': function () {
        this.set_custom_report_api();
      },
  ...
  created() {
      ...
      this.channel_list = this.$parent.channels;
    //   this.generate_sov_chart_data();
  },
