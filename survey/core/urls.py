...
urlpatterns = [
    ...
    path('manage-community/<int:project_id>', views.ManageCommunity.as_view(), name="community_member"),
    path('change-cm-status/<int:project_id>/<int:pk>', views.ChangeCMStatus, name="change_cm_status"),
